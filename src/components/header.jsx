            ...
            <header className="header">
                ...
                {(pageTitle === "Mis Cartas" || pageTitle === "Tienda") && (
                    <div className="header__user">
                        <p className="header__user__money">{user.money}</p><img className="pokecuarto" src="/assets/images/profileImg/pokecuartos.webp" alt="pokecuarto" />
                        <div className="header__user__profImg" onClick={handleOverlay}>
                            <img src={profImg} alt={user.username} />
                        </div>
                        <div className={`header__user__profImg-overlay ${overlay ? 'active' : ''}`} onClick={download}>
                            <p>Descargar Datos</p><img src="/assets/logos/download.png" alt="download" />
                        </div>
                    </div>
                )}
            </header>
